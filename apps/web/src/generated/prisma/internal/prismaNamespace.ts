...
> = {
  ...
  meta: {
    modelProps: "user" | "merchant" | "product" | "paymentHistory";
    ...
    PaymentHistory: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.PaymentHistoryCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type PaymentHistoryScalarFieldEnum =
  (typeof PaymentHistoryScalarFieldEnum)[keyof typeof PaymentHistoryScalarFieldEnum];
